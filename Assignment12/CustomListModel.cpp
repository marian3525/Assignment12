...
bool CustomListModel::insertRows(int position, int rows, const QModelIndex & index)
{
...
bool CustomListModel::removeRows(int position, int rows, const QModelIndex & index)
{
